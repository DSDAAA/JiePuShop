...
CREATE TABLE `t_category` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin DEFAULT NULL,
  `parent_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_bin;
...
CREATE TABLE `t_collect` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKa6u3cwuyfr9k922icwlvtr05s` (`shop_id`),
  KEY `FKhcm1elixqq7pr3jcj1tgmw67g` (`user_id`),
  CONSTRAINT `FKa6u3cwuyfr9k922icwlvtr05s` FOREIGN KEY (`shop_id`) REFERENCES `t_shop` (`id`),
  CONSTRAINT `FKhcm1elixqq7pr3jcj1tgmw67g` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`)
...
CREATE TABLE `t_order` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKgd5x0cg20ym5eu2yaa5ci9y5e` (`shipping_address_id`),
  KEY `FKho2r4qgj3txpy8964fnla95ub` (`user_id`),
  CONSTRAINT `FKgd5x0cg20ym5eu2yaa5ci9y5e` FOREIGN KEY (`shipping_address_id`) REFERENCES `t_shipping_address` (`id`),
...
CREATE TABLE `t_order_item` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `num` int NOT NULL,
  `order_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin DEFAULT NULL,
  `shop_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK2y83rerik30vumt2a1mff6606` (`order_id`),
  KEY `FKifmjpjj6m168o377bjemowamq` (`shop_id`),
  CONSTRAINT `FK2y83rerik30vumt2a1mff6606` FOREIGN KEY (`order_id`) REFERENCES `t_order` (`id`),
  CONSTRAINT `FKifmjpjj6m168o377bjemowamq` FOREIGN KEY (`shop_id`) REFERENCES `t_shop` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_bin;
...
CREATE TABLE `t_recommend_shop` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `shops` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin DEFAULT NULL,
  `user_id` bigint DEFAULT NULL,
  `recommand_value` double DEFAULT NULL,
  `shops_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKer14clyvm2iv2kucwjs2i1utd` (`user_id`),
  KEY `FKev9k6e6h1iqdbpw1x8ub2mp3p` (`shops_id`),
  CONSTRAINT `FKer14clyvm2iv2kucwjs2i1utd` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`),
  CONSTRAINT `FKev9k6e6h1iqdbpw1x8ub2mp3p` FOREIGN KEY (`shops_id`) REFERENCES `t_shop` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=196 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_bin;
...
CREATE TABLE `t_shipping_address` (
  ...
  `phone_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin DEFAULT NULL,
  `user_id` bigint DEFAULT NULL,
  `default_value` bit(1) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_0900_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK3qauju1dkwl0hs8j44357mqt6` (`user_id`),
  CONSTRAINT `FK3qauju1dkwl0hs8j44357mqt6` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`)
...
CREATE TABLE `t_shop` (
  ...
  `img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin DEFAULT NULL,
  `info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin DEFAULT NULL,
  `price` decimal(19,2) DEFAULT NULL,
  `selling_price` decimal(19,2) DEFAULT NULL,
  `stat` bit(1) NOT NULL,
  `stock_num` int NOT NULL,
  `store` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin DEFAULT NULL,
  `category_id` bigint DEFAULT NULL,
  `sales_volume` bigint NOT NULL,
  `visit_volume` bigint NOT NULL,
  `intro` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin,
  `tags` varchar(255) COLLATE utf8mb4_0900_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKtjlaq3m1p88ck3gt7j94yh3w5` (`category_id`),
  CONSTRAINT `FKtjlaq3m1p88ck3gt7j94yh3w5` FOREIGN KEY (`category_id`) REFERENCES `t_category` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10907 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_bin;
...
CREATE TABLE `t_shop_car` (
  ...
  `user_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKls6ykgk3eta9ye3a3gejebv47` (`shop_id`),
  KEY `FKeiw535j2u6m74kscsloj7ttpq` (`user_id`),
  CONSTRAINT `FKeiw535j2u6m74kscsloj7ttpq` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`),
  CONSTRAINT `FKls6ykgk3eta9ye3a3gejebv47` FOREIGN KEY (`shop_id`) REFERENCES `t_shop` (`id`)
...
CREATE TABLE `t_user` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin DEFAULT NULL,
  `e_mail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin DEFAULT NULL,
  `is_lock` bit(1) NOT NULL,
  `login_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin DEFAULT NULL,
  `nick_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin DEFAULT NULL,
  `password_md5` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin DEFAULT NULL,
  `phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
